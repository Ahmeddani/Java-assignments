...
public class Exercises {
	...
	public String middleThree(String str) {
		...
		//we get the index of the middle char of the string by performing 
		//Integer division on the length of the string's length.
		int middleCharIndex = str.length() / 2;
		return str.substring(middleCharIndex - 1, middleCharIndex + 2);
	}
	...
	public boolean hasBad(String str) {
		...
		//This will get the starting index of the substring bad in the string
	...
	public String stringSplosion(String str) {
		...
		String stringSplotion = "";
		int j = 0;
		for(int i = 1; i <= str.length(); i++) {
			
			stringSplotion += str.substring(j, i);
			j = 0;
		}
		return stringSplotion;
	}
	...
	public int last2(String str) {
		...
		for(int i = 0; i < str.length() - 2; i++) {
			...
			if(last2.equals(str.substring(i, i+2))) {
	...
	public String stringX(String str) {
		...
		if(str.length() == 0) {
			...
			String newVersion = str.substring(0,1);
	...
	public String altPairs(String str) {
		...
		for(int i = 0; i < str.length(); i+=4) {
			...
			pairVersion = pairVersion + str.substring(i, endIndex);
